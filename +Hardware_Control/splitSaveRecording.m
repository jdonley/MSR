...
%     Rec_Sigs_Q = Recordings( seg, ceil(end/2)+1:end );  %#ok<NASGU>
    Rec_Sigs_B = Recordings( seg, system_info.recordChZoneAlloc==1 ); %Assumes odd number of recordings has one more recording in bright zone
    Rec_Sigs_Q = Recordings( seg, system_info.recordChZoneAlloc==2 ); 
