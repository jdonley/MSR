...
masker_signal_info.L_noise_mask = 0; % dB
...
Hardware_Control.playMSR( Main_Setup, signal_info, system_info );
%Hardware_Control.playMSR( Main_Setup, signal_info, system_info, Masker_Setup, masker_signal_info );
