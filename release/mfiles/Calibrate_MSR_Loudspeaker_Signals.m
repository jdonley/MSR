...
% Calibrates the generated loudspeaker signals with their associated hardware equalisation filters
% 
% Syntax:	CALIBRATE_MSR_LOUDSPEAKER_SIGNALS( SYS )
% 
% Inputs: 
% 	SYS - Soundfield Reproduction system object
% 
% Example: 
% 	Calibrate_MSR_Loudspeaker_Signals( Current_Systems.loadCurrentSRsystem )
% 
