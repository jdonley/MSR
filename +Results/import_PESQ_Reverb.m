function [Noise_Mask_Level,PESQ_Bright,ConfInt_Bright_Low,ConfInt_Bright_Up] = import_PESQ_Reverb(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [NOISE_MASK_LEVEL,PESQ_BRIGHT,CONFINT_BRIGHT_LOW,CONFINT_BRIGHT_UP]
%   = import_PESQ_Reverb(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   [NOISE_MASK_LEVEL,PESQ_BRIGHT,CONFINT_BRIGHT_LOW,CONFINT_BRIGHT_UP]
