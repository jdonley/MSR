...
for scheme = setups
    ...
    elseif scheme == 10.11
        % % Setup and Privacy Scheme 10
        % Multizone vs PAL Privacy Scheme Part 2.1 - Flat Masker
        Masker_Type = 'FlatMasker';
        Zone_Weights = 1e4;
        Noise_Mask_Levels = Noise_Mask_Levels_;
        main_layout = { ...
            'brightzone_pos_angle',        90, ...
    ...
    Other_Setup = Speaker_Setup.createSetup({ masker_layout{:}, loudspeaker_layout{:}});
    
    Broadband_Tools.Generate_Loudspeaker_Signals_batchfunc(Zone_Weights, Noise_Mask_Levels, Masker_Type, Main_Setup, Other_Setup);
