function Broadband_PrivacyWeighted_v6_FlatMask( Input_file_path, Input_file_name, Input_file_ext, LUT_resolution, Noise_Mask_dB, loudspeaker_setup )
...
fileID = fopen(['+Results\' Output_file_path_ext 'PESQ_Results_Privacy_Weighted_' Version '.csv'],'a');
...
fileID = fopen(['+Results\' Output_file_path_ext 'PESQ_MOS_Results_Privacy_Weighted_' Version '.csv'],'a');
...
fileID = fopen(['+Results\' Output_file_path_ext 'ASL_Results_Privacy_Weighted_' Version '.csv'],'a');
...
fileID = fopen(['+Results\' Output_file_path_ext 'SI_Results_Privacy_Weighted_' Version '.csv'],'a');
