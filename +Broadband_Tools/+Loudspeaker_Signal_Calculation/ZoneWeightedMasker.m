function ZoneWeightedMasker( Signal_Length, SYS_or_LUT_resolution, Noise_Mask_dB, weight, setup, multizone_setup )
...
elseif nargin == 6
    ...
    signal_info.method = 'ZoneWeightMasker';
end
