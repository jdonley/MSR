...
% clear Loudspeakers_; % Save on memory
 ...
 Masking_Noise = max(Loudspeaker_Signals(:))/2 * (rand(size(Loudspeaker_Signals))*2 -1) * db2mag( Noise_Mask_dB ); % Add (- Noise_Mask_dB) dB of noise to the signal
 Loudspeaker_Signals = Loudspeaker_Signals + Masking_Noise;
