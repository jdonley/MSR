function Broadband_PrivacyWeighted_FlatMask( Input_file_path, Input_file_name, Input_file_ext, LUT_resolution, Noise_Mask_dB, loudspeaker_setup )
...
SetupInfo            = ['_' num2str(f_low ) 'Hz-' ...
    ...
    num2str(Noise_Mask_dB) 'dB_privacy__FlatMask'];
...
fileID = fopen(['+Results\' Output_file_path_ext 'PESQ_Results_Privacy_Weighted_FlatMask.csv'],'a');
...
fileID = fopen(['+Results\' Output_file_path_ext 'PESQ_MOS_Results_Privacy_Weighted_FlatMask.csv'],'a');
...
fileID = fopen(['+Results\' Output_file_path_ext 'ASL_Results_Privacy_Weighted_FlatMask.csv'],'a');
...
fileID = fopen(['+Results\' Output_file_path_ext 'SI_Results_Privacy_Weighted_FlatMask.csv'],'a');
