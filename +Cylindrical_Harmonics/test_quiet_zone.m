...
%% Zone 1, Frequency 1
    ...
    zones = [zones Cylindrical_Harmonics.spatial_zone(f, 0.3, 'pw', 1.0, 15)];    
    zones = [zones Cylindrical_Harmonics.spatial_zone(f, 0.3, 'quiet')];
...
%% Frequency 1
    monofields = [monofields Cylindrical_Harmonics.global_soundfield];
...
%% Wideband field
    soundfield = Cylindrical_Harmonics.wideband_soundfield;
