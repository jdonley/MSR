...
ii. Download the Windows 64-bit version of the MATLAB Runtime for R2015b from:
...
2. Installing the MSR Package

A. Go to the directory that contains the file setup.py and the subdirectory MSR. If you 
...
3. Using the MSR Package

The MSR package is on your Python path. To import it into a Python script or session, 
   simply execute:
