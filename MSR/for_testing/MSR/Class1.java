...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    /**
     * Maintains information used in calling the <code>MSR</code> M-function.
     */
    private static final MWFunctionSignature sMSRSignature =
    ...
    {
        this(MSRMCRFactory.newInstance());
    }
    ...
    {
        this(MSRMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(MSRMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MSRMCRFactory.newInstance();
            mcr.runMain( sMSRSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>MSR</code> M-function 
     ...
     */
    public void MSR(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sMSRSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MSR(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sMSRSignature);
    }

    /**
     * Provides the standard interface for calling the <code>MSR</code>
     * M-function with 19 input arguments.
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] MSR(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sMSRSignature), 
                    sMSRSignature);
        return lhs;
    }
}
