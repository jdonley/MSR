...
Frequency_weights    = [ linspace(90   ,90   , length(Frequencies_in_zones))   ;...     % Importance weight for quiet zone of Zone 1
                         linspace(90   ,90   , length(Frequencies_in_zones))   ];       % Importance weight for quiet zone of Zone 2
...
%%
Bright_Max_Error = Bright_Error;
Quiet_Max_SPL    = Quiet_SPL;
...
save(['+Perceptual_Models\Error_Limits_' num2str(samples) 'samples.mat'], ...
    ...
    '-append');
%%
saveas(h,'+Perceptual_Models\Maximum_Constraints.fig');
