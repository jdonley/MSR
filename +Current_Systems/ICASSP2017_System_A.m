function SR_SYSTEM = ICASSP2017_System_A()
...
elseif ~isempty(strfind(lower(array_type), 'line'))
    x_=spkr_radius;
    th_c = 180;
...
Main_Setup(1) = Speaker_Setup.createSetup({...
    ...
    'brightzone_radius',            0.9, ...
    'brightzone_pos_distance',      Br, ...
    'quietzone_radius',             0.9, ...
