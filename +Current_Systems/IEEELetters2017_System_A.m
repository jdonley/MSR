...
Room_Setup = Room_Setup.setRoomSize( [4 6 3] ); % Custom
    
Room_Setup = Room_Setup.setReproductionCentre( [2 2 1.5] ); % Centre of room
...
Main_Setup(3) = Speaker_Setup.createSetup({...
    'frequency',                    1000, ...
    field_layout{:}, ...
    imagesrc_layout{:}, ...
    'resolution',                   100, ... % Minimum resolution of approx 50 for 8kHz signal to satisfy nyquist theorem. We choose 100 for good measure.
