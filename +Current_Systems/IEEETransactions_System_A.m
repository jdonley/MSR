...
publication_info.axes_gap = [0.5 0.5]; %Gap between axes [gap_height gap_width]
publication_info.axes_margins_height = [1 1]; %Axes height margins [lower upper]
publication_info.axes_margins_width = [1 1]; %Axes width margins [left right]
