function SR_SYSTEM = IEEETransactions_System_F()
...
rec_types = {'simulated'}; % The type of recordings to be analysed
...
analysis_info.Nfft = 128 *1e-3*signal_info.Fs;%1024;% Number of fft components
analysis_info.f_low = 100; % Hz
analysis_info.f_high = 7500; % Hz

%% Publication Figure Setup Information
publication_info.DocumentPath = 'tex\latex\IEEE_Trans2016';
publication_info.FigureName = 'IEEE_Trans2016_F';
