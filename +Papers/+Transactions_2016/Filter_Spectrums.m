...
pl_0 = plot(f1/1e3, mag2db(SQuiet / mean(SQuiet(f1band)) ) ,'-','color',[0 0 0 1],'LineWidth',lineWid); hold on
...
pl_1 = plot(f1/1e3, mag2db(SBright / mean(SBright(f1band)) ) ,'-','color',[0 0 0 1],'LineWidth',lineWid); hold on
